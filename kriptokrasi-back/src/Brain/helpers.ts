export async function profitCalculator(price, buyPrices, leverage) {
    if (price >= buyPrices[5]) {
        ...
        return [leverage *(buyPrices[0] - price) * (100 / buyPrices[0]), tp1, tp2, tp3, tp4, buyPrices[5]];
    }
        ...
        return [leverage *(buyPrices[0] - price) * (100 / buyPrices[0]), tp1, tp2, tp3, buyPrices[4], buyPrices[5]];
    }
    else if (price >= buyPrices[2]) {
        let tp2 = leverage * ((buyPrices[2] - price) * (20 / buyPrices[2]) + (buyPrices[1] - price) * (20 / buyPrices[1]));
        let tp1 = leverage * ((buyPrices[1] - price) * (20 / buyPrices[1]));

        return [leverage *(buyPrices[0] - price) * (100 / buyPrices[0]), tp1, tp2, buyPrices[3], buyPrices[4], buyPrices[5]];
    }
    else if (price >= buyPrices[1]) {
        let tp1 = leverage * ((buyPrices[1] - price) * (20 / buyPrices[1]));

        return [leverage *(buyPrices[0] - price) * (100 / buyPrices[0]), tp1, buyPrices[2], buyPrices[3], buyPrices[4], buyPrices[5]];
    }
    else return [leverage *(buyPrices[0] - price) * (100 / buyPrices[0]), buyPrices[1], buyPrices[2], buyPrices[3], buyPrices[4], buyPrices[5]];
}